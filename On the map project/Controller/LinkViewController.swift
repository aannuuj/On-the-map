...
class LinkViewController: UIViewController {
    ...
    @IBAction func submitClicked(_ sender: UIButton) {
        // Data to be sent
        let student = NewStudentRequest(uniqueKey: "1234", firstName: "Hariom", lastName: "Palkar", mapString: address, mediaURL: mediaUrl, latitude: Double(location.coordinate.latitude), longitude: Double(location.coordinate.longitude))
